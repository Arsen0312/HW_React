...
// Задание:
// Создайте родительский компонент и два дочерних компонента. Передайте свойства из
// родительского компонента в каждый из дочерних компонентов. Используйте эти свойства для 
// отображения информации в каждом дочернем компоненте. Информация может быть любой, главое
// чтобы она передавалась пропсом (свойством)
